...
namespace Activity_2_RegisterAndLoginApp.API
{
    ...
    public class GameAPIController : ControllerBase
    {
        ...
        public ActionResult<bool> deleteSavedGame(int id)
        {
            return repository.deleteGame(id);
        }

        [HttpPost("saveGame")]
        public ActionResult<bool> saveGame([FromBody] GameModelDTO gameDTO)
        {
